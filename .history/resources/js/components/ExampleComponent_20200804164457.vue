    ...
    export default {
        ...
        methods:{
            getTasks(){
                ...
                axios.get(this.url_base+url).then(function (response) {
            ...
            saveTasks(){
                ...
                axios.post(this.url_base+url,{ //estas variables son las que enviaremos para que crear la tarea
                    'name':this.name,
            ...
            loadFieldsUpdate(data){ //Esta función rellena los campos y la variable update, con la tarea que queremos modificar
                ...
                axios.get(url_base+url).then(function (response) {
